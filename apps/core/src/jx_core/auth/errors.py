...
ERROR_DEFINITIONS: dict[str, tuple[int, str]] = {
    ...
    "admin_self_password_change_required": (409, "请使用当前账号的修改密码流程"),
    ...
    "rule_unavailable": (409, "赛制不存在、不是 4v4、未启用或主持音频未就绪"),
    "topic_unavailable": (409, "辩题不存在或已停用"),
    "agent_unavailable": (409, "Agent 不存在、已停用或其模型/音色不可用"),
    "agent_capacity_insufficient": (409, "可用 Agent 数量不足，请先启用至少 8 个可用 Agent"),
    "format_not_published": (409, "请先为该赛制发布可用版本，再创建或启动实验房间"),
    ...
    "host_audio_duration_unavailable": (409, "主持音频尚未完成校验，请稍后重试"),
    ...
    "experiment_disabled": (409, "论文实验功能当前未开放"),
    "experiment_batch_not_found": (404, "实验批次不存在"),
    "experiment_batch_code_taken": (409, "实验批次编号已存在"),
    "experiment_batch_locked": (409, "实验批次已经发布，不能修改基础信息"),
    "experiment_batch_active": (409, "该批次仍有活动房间或比赛，请先终止对应 attempt"),
    "experiment_batch_has_attempts": (409, "该草稿已有比赛记录，不能删除；请改为停用"),
    "experiment_account_conflict": (409, "匿名实验账号与现有账号冲突"),
    "experiment_roster_invalid": (422, "实验队伍、参与者或专家配置不符合要求"),
    "experiment_roster_incomplete": (409, "请先配置 6 队、18 名参与者和 6 个固定 Agent"),
    "experiment_schedule_invalid": (422, "实验排表不符合发布约束"),
    "experiment_schedule_incomplete": (409, "请先生成并校验完整的 18 场正式赛排表"),
    "experiment_participant_required": (403, "当前账号不属于该实验批次"),
    "experiment_appointment_not_found": (404, "实验预约不存在"),
    "experiment_unavailable": (409, "该实验批次当前不可进入"),
    "experiment_room_not_created": (409, "预约房间尚未由参赛者创建"),
    "experiment_training_quota_exhausted": (409, "你的训练房间次数已用完"),
    "experiment_match_completed": (409, "该预约已经正常完成，不能重复开赛"),
    "experiment_attempt_active": (409, "该预约已有进行中或暂停的比赛，请先终止"),
    "experiment_attempt_invalid": (409, "实验比赛关联已损坏，请联系管理员"),
    "experiment_fixed_seats": (409, "实验房间席位已由排表固定，不能修改"),
    "experiment_use_appointment": (409, "请从“我的实验预约”进入固定席位"),
    "experiment_model_mismatch": (409, "实验 Agent 必须使用批次规定的 deepseek-v4-flash-0731 模型"),
    "experiment_annotation_not_found": (404, "标注任务不存在或不属于当前账号"),
    "experiment_annotation_invalid": (409, "标注任务数据不完整，请联系管理员"),
    "experiment_annotation_locked": (409, "标注任务已经提交，不能继续修改"),
    "experiment_annotation_stage_locked": (409, "该阶段已经锁定，不能继续修改"),
    "experiment_annotation_version_conflict": (409, "答案已在其他页面更新，请刷新后重试"),
    "experiment_annotation_answer_invalid": (422, "标注答案不符合题目要求"),
    "experiment_annotation_incomplete": (409, "请完成全部事件标注后再提交"),
    "experiment_annotation_required": (409, "请完成当前阶段后再查看实际发言"),
    "postmatch_survey_required": (409, "请先完成上一场赛后问卷后再进入下一场"),
    "experiment_questionnaire_incomplete": (409, "请完成整场问卷后再提交"),
    "experiment_annotation_audio_unavailable": (409, "该发言音频暂不可用"),
    "experiment_expert_task_not_found": (404, "专家标注任务不存在"),
    "experiment_expert_opportunity_not_found": (404, "专家标注机会不存在"),
    "experiment_expert_task_locked": (409, "专家任务已经提交，不能继续修改"),
    "experiment_expert_answer_locked": (409, "该机会已经锁定，不能继续修改"),
    "experiment_expert_answer_invalid": (422, "专家标注答案不符合题目要求"),
    "experiment_expert_task_incomplete": (409, "请完成全部机会标注后再提交"),
    "experiment_expert_batch_incomplete": (409, "该批次仍有未完成的专家标注"),
    "experiment_job_not_found": (404, "实验后台任务不存在"),
    "experiment_export_unavailable": (409, "研究导出尚未生成或已不可用"),
    "survey_answer_invalid": (422, "问卷答案格式不正确"),
    "survey_answer_incomplete": (409, "请完成问卷必答题后再提交"),
    "survey_conflict": (409, "问卷已在其他请求中更新，请刷新后重试"),
    "survey_locked": (409, "问卷已经提交，不能继续修改"),
    "survey_not_found": (404, "问卷任务不存在或不属于当前账号"),
    "survey_questions_invalid": (422, "问卷题目配置不正确"),
    "survey_export_format_invalid": (422, "导出格式只支持 CSV 或 JSON"),
    "format_draft_exists": (409, "该赛制已经存在草稿版本，请先编辑或删除草稿"),
    "format_not_found": (404, "赛制版本不存在"),
    "format_immutable": (409, "已发布赛制版本不可修改，请复制为新草稿"),
    "format_revision_conflict": (409, "赛制草稿已被其他页面修改，请刷新后重试"),
    "format_publish_dependencies_missing": (409, "赛制仍缺少可发布的规则、音频、模型或音色依赖"),
    "format_agents_missing": (409, "请先为该赛制版本配置 Agent"),
    "format_prompt_variable_missing": (422, "Prompt 变量声明与模板正文不一致"),
    "format_prompt_missing": (
        422,
        "缺少运行所需的 Prompt，请配置赛制默认模板或为每个 Agent 配置覆盖模板",
    ),
    "format_agent_not_found": (404, "该 Agent 不属于当前赛制版本"),
    "format_agent_voice_duplicate": (409, "同一赛制版本的 Agent 不能重复使用音色"),
    "format_agent_parameter_invalid": (422, "Agent 参数不在所选模型声明的能力范围内"),
    "format_module_not_found": (404, "赛制模块不存在"),
    "legacy_agent_read_only": (409, "旧版全局 Agent 仅供历史兼容；请在赛制草稿中创建 Agent"),
}
