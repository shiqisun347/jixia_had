...
2. 变更超过单文件文档修正时，先在 `specs/` 写 v2.0 规格，说明范围、验收和回滚边界；未批准前不写业务代码。
...
当前固定版本为 **v2.0**，新建房间只支持正式 4v4。历史非 4v4
房间和比赛保留只读兼容；新工作必须以 v2.0 事实来源和
`specs/README.md` 为入口。规格 161–170 是 v1.0 历史回归证据，v2.0
规格从 200 开始。
